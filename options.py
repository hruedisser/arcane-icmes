...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--spacecraft', type=str, default='Wind', help="Which spacecraft data should be processed (all, Wind, STEREO-A, STEREO-B).")
        ...
        self.parser.add_argument('--std_features', default=True, help="bx, by, bz, bt, vt, np")
        self.parser.add_argument('--remove_features', default=None, help="features to remove")
        ...
        self.parser.add_argument('--pretrain', default = False, help="Prerain the model")
        ...
        self.parser.add_argument('--seed', default = 42, help="Random seed")
        ...
        self.parser.add_argument('--schedule',choices={"cyclic", "warmup"},    default="cyclic", help="Learning Rate Schedule. ")
